...
v9_fields = {
    ...
    44: {"Name": "Vendor Proprietary", "Type": "Vendor Proprietary", "Index ID": "Vendor Proprietary"},
# Cisco Catalyst Proprietary
    45: {"Name": "Vendor Proprietary", "Type": "Vendor Proprietary", "Index ID": "Vendor Proprietary"},
# Cisco Catalyst Proprietary
    46: {
...
# Mikrotik, ASA
    228: {"Name": "postNAPTDestinationTransportPort", "Type": "Integer",
          "Index ID": "Post-NAT Destination Transport Port"},  # Mikrotik, ASA
    229: {
    ...
    354: {"Name": "ingressUnicastPacketTotalCount", "Type": "Integer",
          "Index ID": "Ingress Unicast Packet Total Count"},
    355: {"Name": "ingressMulticastPacketTotalCount", "Type": "Integer",
          "Index ID": "Ingress Multicast Packet Total Count"},
    356: {"Name": "ingressBroadcastPacketTotalCount", "Type": "Integer",
          "Index ID": "Ingress Broadcast Packet Total Count"},
    357: {"Name": "egressUnicastPacketTotalCount", "Type": "Integer", "Index ID": "Egress Unicast Packet Total Count"},
    358: {"Name": "egressBroadcastPacketTotalCount", "Type": "Integer",
          "Index ID": "Egress Broadcast Packet Total Count"},
    359: {"Name": "monitoringIntervalStartMilliSeconds", "Type": "Integer",
          "Index ID": "Monitoring Interval Start MilliSeconds"},
    360: {"Name": "monitoringIntervalEndMilliSeconds", "Type": "Integer",
          "Index ID": "Monitoring Interval End MilliSeconds"},
    ...
    378: {"Name": "distinctCountOfSourceIPAddress", "Type": "Integer",
          "Index ID": "Distinct Count Of Source IP Address"},
    379: {"Name": "distinctCountOfDestinationIPAddress", "Type": "Integer",
          "Index ID": "Distinct Count Of Destination IP Address"},
    380: {"Name": "distinctCountOfSourceIPv4Address", "Type": "Integer",
          "Index ID": "Distinct Count Of Source IPv4 Address"},
    381: {"Name": "distinctCountOfDestinationIPv4Address", "Type": "Integer",
          "Index ID": "Distinct Count Of Destination IPv4 Address"},
    382: {"Name": "distinctCountOfSourceIPv6Address", "Type": "Integer",
          "Index ID": "Distinct Count Of Source IPv6 Address"},
    383: {"Name": "distinctCountOfDestinationIPv6Address", "Type": "Integer",
          "Index ID": "Distinct Count Of Destination IPv6 Address"},
    384: {
    ...
    415: {"Name": "dot1qCustomerDestinationMacAddress", "Type": "MAC",
          "Index ID": "Dot1q Customer Destination MAC Address"},
    ...
    421: {"Name": "postMCastLayer2Octet Total Count", "Type": "Integer",
          "Index ID": "Post-Multicast Layer 2 Total Bytes"},
    ...
    443: {"Name": "mibObjectValueTable", "Type": "", "Index ID": "MIB ObjectValueTable"},
# Options Template for an SNMP MIB
    444: {"Name": "mibObjectValueRow", "Type": "", "Index ID": "MIB ObjectValueRow"},
# Options Template for an SNMP MIB
...
# Use to calculate ICMP Type and Code (x * 256 + Code)
...
# Assigned for Netflow v9 compatibility
    ...
    227: {"Name": "postNAPTSourceTransportPort", "Type": "Integer", "Index ID": "Post-NAT Source Transport Port"},
    228: {"Name": "postNAPTDestinationTransportPort", "Type": "Integer",
          "Index ID": "Post-NAT Destination Transport Port"},
    229: {
        "Name": "natOriginatingAddressRealm",
        "Type": "Integer",
        "Index ID": "NAT Originating Address Realm",
...
# REVIEW THIS
    ...
    421: {"Name": "postMCastLayer2OctetTotalCount", "Type": "Integer",
          "Index ID": "Post-Multicast Layer 2 Total Bytes"},
    422: {"Name": "minimumLayer2TotalLength", "Type": "Integer", "Index ID": "Minimum Layer 2 Total Length"},
    423: {"Name": "maximumLayer2TotalLength", "Type": "Integer", "Index ID": "Maximum Layer 2 Total Length"},
    424: {"Name": "droppedLayer2OctetDeltaCount", "Type": "Integer", "Index ID": "Dropped Layer 2 Bytes"},
    ...
    432: {"Name": "pseudoWireDestinationIPv4Address", "Type": "IPv4",
          "Index ID": "Pseudo-Wire Destination IPv4 Address"},
